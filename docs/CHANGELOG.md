2026-05-18: תיקון callback נדרים פלוס — registrationId מוטמע ב-URL (?rid=) כי נדרים חותך Param1 ל-8 תווים בלבד (Airtable record ID = 17 תווים)
2026-05-18: Built complete camp registration system — Next.js 15 multi-step form, Airtable integration, Nedarim Plus payment iframe, cash fallback page, TypeScript clean, production build passing.
